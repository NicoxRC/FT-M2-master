...
const spanName = document.querySelector('#createdBy');
spanName.innerHTML += ' Nicolas Rojas';
...
// Tu código acá:
const buttom = document.getElementById('addButton');
buttom.addEventListener('click', addToDo);
